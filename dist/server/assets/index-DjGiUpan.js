import { S as reactExports, J as jsxRuntimeExports, R as React } from "./server-rwvygWyP.js";
import { R as ReactDOM } from "./router-oAyGKiVW.js";
...
function LoadingScreen({ onDone }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: visible && /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex items-center justify-center", style: { width: 320, height: 320 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 animate-spin-slow", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { viewBox: "0 0 320 320", className: "w-full h-full", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "grad1", x1: "0%", y1: "0%", x2: "100%", y2: "100%", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", stopColor: "oklch(0.85 0.15 200)" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", stopColor: "oklch(0.65 0.22 245)" })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "160", cy: "160", r: "150", fill: "none", stroke: "url(#grad1)", strokeWidth: "1", strokeDasharray: "4 8", opacity: "0.5" })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-8 animate-spin-reverse", children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { viewBox: "0 0 256 256", className: "w-full h-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "128", cy: "128", r: "120", fill: "none", stroke: "oklch(0.85 0.15 200 / 0.4)", strokeWidth: "1", strokeDasharray: "2 14" }) }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { viewBox: "0 0 280 280", className: "absolute inset-5 -rotate-90", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("defs", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "progGrad", x1: "0%", y1: "0%", x2: "100%", y2: "100%", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", stopColor: "oklch(0.85 0.15 200)" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", stopColor: "oklch(0.65 0.22 245)" })
              ] }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "140", cy: "140", r: R, fill: "none", stroke: "oklch(0.2 0.04 260)", strokeWidth: "4" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "circle",
              {
                ...
                strokeLinecap: "round",
                strokeDasharray: C,
                strokeDashoffset: C - progress2 / 100 * C,
                filter: "url(#glow)",
            ...
            Array.from({ length: 60 }).map((_, i) => {
              ...
              const active = i / 60 < progress2 / 100;
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex flex-col items-center justify-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-6xl font-bold text-gradient glow-text tabular-nums tracking-tight", children: [
              Math.floor(progress2),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl text-cyan-glow", children: "%" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 text-xs tracking-[0.4em] text-cyan-glow/70 uppercase", children: "Initializing" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12 flex gap-1", children: Array.from({ length: 5 }).map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.span,
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 text-[10px] tracking-[0.3em] text-muted-foreground uppercase", children: "Richard M · Loading Experience" })
      ]
    }
  ) });
}
const brandLogo = "/assets/richard-logo-CPz2gDs-.png";
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: `fixed top-0 inset-x-0 z-50 transition-all ${scrolled ? "backdrop-blur-xl bg-background/70 border-b border-border" : "bg-transparent"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6 h-16 flex items-center justify-between", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "#home", className: "font-bold text-lg tracking-wider flex items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: brandLogo, alt: "Richard Martinez logo", className: "w-9 h-9 rounded-full object-cover shadow-[0_0_20px_oklch(0.65_0.22_245_/_0.6)] ring-1 ring-cyan-glow/40" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "RICHARD" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: ".M" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "hidden md:flex items-center gap-8 text-sm", children: links.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: `#${l.toLowerCase()}`, className: "text-foreground/90 hover:text-cyan-glow transition-colors font-medium", children: l }) }, l)) })
  ] }) });
}
...
const logo = "/assets/richard-portrait-BFHj8frs.png";
const moonImg = "/assets/moon-D8E-HCN2.jpg";
const variants = {
...
function Reveal({
  ...
  const ref = reactExports.useRef(null);
  const inView2 = useInView(ref, { once: false, margin: "-80px" });
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.div,
    {
      ref,
...
function Home() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "home", className: "relative min-h-screen flex items-center justify-center overflow-hidden pt-20", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 grid-bg opacity-40" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/3 left-1/4 w-96 h-96 rounded-full bg-blue-glow/20 blur-[120px]" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-1/4 right-1/4 w-96 h-96 rounded-full bg-cyan-glow/20 blur-[120px]" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto max-w-7xl px-6 grid lg:grid-cols-2 gap-16 lg:gap-20 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { variant: "fade", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block px-4 py-1.5 rounded-full border border-primary/40 bg-primary/10 text-xs tracking-[0.3em] text-cyan-glow uppercase", children: "Senior Software Engineer · Analytics · Full Stack" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { variant: "rise", delay: 0.1, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "mt-6 text-5xl md:text-7xl font-bold leading-[1.05] tracking-tight", children: [
          "Hi, I'm ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient glow-text", children: "Richard Martinez." })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { variant: "thread", delay: 0.25, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-4 text-2xl md:text-3xl text-foreground/90", children: [
          "I build ",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { variant: "fade", delay: 0.55, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 flex flex-wrap gap-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#contact", className: "inline-flex items-center px-7 py-3.5 rounded-full border border-primary/40 text-cyan-glow hover:bg-primary/10 transition-colors", children: "Contact Me" })
        ] }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { variant: "spinner", delay: 0.2, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex h-[520px] w-full items-end justify-center md:h-[640px] lg:ml-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-1/2 top-1/2 h-[460px] w-[460px] -translate-x-1/2 -translate-y-[58%] md:h-[600px] md:w-[600px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "moon-pulse h-full w-full moon-halo", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: moonImg,
              alt: "Glowing moon",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 float animate-float-orb transform -translate-y-6 md:-translate-y-8 lg:-translate-y-10", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -inset-6 rounded-full bg-aurora opacity-30 blur-3xl" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
                src: logo,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none absolute inset-x-0 -bottom-2 h-[220px] bg-gradient-to-t from-background via-background/40 to-transparent blur-3xl opacity-95" })
      ] })
    ] })
  ] });
}
const highlights = [
  { icon: ChartColumn, label: "Analytics & Marketplace Strategy" },
  { icon: Database, label: "Data Engineering & ETL Pipelines" },
  { icon: CodeXml, label: "Full Stack · C# · .NET Core · React" },
...
function About() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", className: "relative py-32 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-6xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { variant: "thread", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-5xl md:text-6xl font-bold", children: [
        "About ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "Me" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto mt-4 h-1 w-24 rounded-full bg-gradient-brand" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mx-auto mt-6 max-w-2xl text-muted-foreground", children: "Senior Software Engineer turning complex business data into reliable decisions, dashboards, and scalable platforms." })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-20 grid lg:grid-cols-5 gap-12 items-start", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { variant: "diamond", className: "lg:col-span-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative rounded-2xl overflow-hidden border border-primary/30 shadow-glow p-8 bg-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -inset-1 bg-gradient-brand opacity-20 blur-2xl -z-10" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-7xl font-bold text-gradient glow-text", children: "10+" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 text-sm tracking-[0.3em] uppercase text-cyan-glow", children: "Years of Experience" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "KPI Dashboards Built", value: "100+" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "ETL Pipelines Deployed", value: "80+" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "Cloud Deployments", value: "50+" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "Tech Stack", value: "15+" })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-3 space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { variant: "fade", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-2xl font-bold", children: [
          "Senior ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-cyan-glow", children: "Software Engineer" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { variant: "fade", delay: 0.1, children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed", children: "Senior Software Engineer with 10+ years of experience building analytics-driven full stack platforms, data pipelines, KPI dashboards, and business intelligence workflows for enterprise and healthcare domains. Strong hands-on background in SQL, Python, C#, .NET Core, React, TypeScript, PostgreSQL, SQL Server, ETL automation, API development, and cloud deployments." }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { variant: "fade", delay: 0.2, children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed", children: "Experienced partnering with Product, GTM, Engineering, and Operations teams to analyze conversion funnels, supply-demand patterns, partner performance, pricing impact, and operational profitability. Skilled in translating ambiguous business questions into reliable dashboards, experiments, automated reporting systems, and AI-assisted analytics workflows that improve decision speed, reduce manual analysis, and support scalable marketplace-style growth." }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 gap-3 pt-4", children: highlights.map((h, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { variant: "fade", delay: 0.05 * i, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 p-3 rounded-lg bg-card border border-border hover:border-primary/50 transition-colors", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-md bg-gradient-brand grid place-items-center text-primary-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsx(h.icon, { className: "w-4 h-4" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: h.label })
        ] }) }, h.label)) })
      ] })
    ] })
  ] }) });
...
function Stat({ label, value }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline justify-between border-b border-border pb-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl font-bold text-cyan-glow tabular-nums", children: value })
  ] });
}
const categories = [
  {
...
function Skills() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "skills", className: "relative py-32 px-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto max-w-7xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { variant: "thread", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto mt-4 h-1 w-24 rounded-full bg-gradient-brand" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mx-auto mt-6 max-w-2xl text-muted-foreground", children: "A full-spectrum toolkit covering analytics, data engineering, full stack development, cloud infrastructure, AI-assisted workflows, and cross-functional leadership." })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-16 grid md:grid-cols-2 lg:grid-cols-3 gap-6", children: categories.map((cat, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { variant: "diamond", delay: idx * 0.08, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-full p-6 rounded-2xl bg-card border border-border hover:border-primary/50 transition-colors group", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-11 h-11 rounded-lg bg-primary/10 border border-primary/30 grid place-items-center text-cyan-glow group-hover:bg-gradient-brand group-hover:text-primary-foreground transition-all", children: /* @__PURE__ */ jsxRuntimeExports.jsx(cat.icon, { className: "w-5 h-5" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-bold", children: cat.title })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: cat.skills.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between mb-1.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-cyan-glow tabular-nums", children: [
              s.level,
              "%"
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1.5 rounded-full bg-secondary overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full rounded-full bg-gradient-brand shadow-glow", style: { width: `${s.level}%` } }) })
        ] }, s.name)) })
      ] }) }, cat.title)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { variant: "fade", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-20", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-center text-2xl font-bold mb-2", children: "Technologies & Tools I Use" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-muted-foreground text-sm mb-10", children: "Day-to-day stack across engineering, analytics, and cloud infrastructure" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap justify-center gap-3", children: tools.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { variant: "spinner", delay: i * 0.02, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-4 py-2 rounded-full border border-primary/30 bg-card text-sm text-foreground/90 hover:border-cyan-glow hover:text-cyan-glow hover:shadow-glow transition-all cursor-default", children: t }) }, t)) })
      ] }) })
    ] })
  ] });
}
const p1 = "/assets/project-1-Qhs1cGia.jpg";
const p2 = "/assets/project-2-DAFlI0Fz.jpg";
const p3 = "/assets/project-3-2vzniTel.jpg";
const p4 = "/assets/project-4-Cy-GvvT2.jpg";
const p5 = "/assets/project-5-wMzV5T9_.jpg";
const p6 = "/assets/project-6-HhvwUMGq.jpg";
const projects = [
  {
...
function Projects() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "projects", className: "relative py-32 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { variant: "thread", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-5xl md:text-6xl font-bold", children: [
        "My ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto mt-4 h-1 w-24 rounded-full bg-gradient-brand" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mx-auto mt-6 max-w-2xl text-muted-foreground", children: "A selection of AI, automation and SaaS work — from voice agents to enterprise CRM platforms." })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-16 grid md:grid-cols-2 lg:grid-cols-3 gap-7", children: projects.map((p, idx) => {
      const variants2 = ["fade", "diamond", "thread", "spinner", "rise", "diamond"];
      return /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { variant: variants2[idx], delay: idx * 0.08, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "a",
        {
          href: p.url,
          target: "_blank",
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-[16/10] overflow-hidden", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: p.image, alt: p.title, className: "w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-card via-card/40 to-transparent" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-3 right-3 w-9 h-9 rounded-full bg-background/80 backdrop-blur grid place-items-center border border-primary/40 text-cyan-glow group-hover:bg-gradient-brand group-hover:text-primary-foreground transition-all", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "w-4 h-4" }) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-bold group-hover:text-cyan-glow transition-colors", children: p.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground line-clamp-3", children: p.description }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 flex flex-wrap gap-1.5", children: p.skills.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-2.5 py-1 rounded-md bg-primary/10 border border-primary/20 text-[11px] text-cyan-glow", children: s }, s)) })
            ] })
          ]
        }
      ) }, p.title);
...
function Contact() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "contact", className: "relative py-32 px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 grid-bg opacity-20" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto max-w-6xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { variant: "thread", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto mt-4 h-1 w-24 rounded-full bg-gradient-brand" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mx-auto mt-6 max-w-2xl text-muted-foreground", children: "Have a project in mind or want to discuss analytics, engineering, or data opportunities? Reach out via any channel below." })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-16 grid lg:grid-cols-2 gap-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { variant: "fade", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-bold mb-3", children: "Contact Information" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mb-8", children: "I'm always open to discussing new projects, data challenges, or opportunities to be part of your team." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: channels.map((c, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { variant: "rise", delay: i * 0.1, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: c.href, className: "flex items-center gap-4 p-4 rounded-xl bg-card border border-border hover:border-primary/50 hover:shadow-glow transition-all", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-lg bg-secondary grid place-items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(c.icon, { className: `w-5 h-5 ${c.color}` }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `font-semibold ${c.color}`, children: c.label }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-muted-foreground", children: c.value })
            ] })
          ] }) }, c.label)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { variant: "diamond", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "form",
          {
            onSubmit: (e) => {
              e.preventDefault();
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-bold", children: "Send Me a Message" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "submit", className: "w-full inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-lg bg-gradient-brand text-primary-foreground font-semibold shadow-glow hover:shadow-cyan transition-all", children: [
                "Send Message ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-24 pt-8 border-t border-border text-center text-sm text-muted-foreground", children: [
        "© ",
        (/* @__PURE__ */ new Date()).getFullYear(),
        " Richard Martinez - Senior Software Engineer · Analytics · Full Stack Developer"
      ] })
    ] })
  ] });
}
