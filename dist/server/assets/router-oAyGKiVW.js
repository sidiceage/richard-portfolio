...
const appCss = "/assets/styles-CbYOe2Fb.css";
...
const Route$1 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "Portfolio" },
      { name: "description", content: "Portfolio Generated Project" },
      { name: "author", content: "Portfolio" },
      { property: "og:title", content: "Portfolio" },
      { property: "og:description", content: "Portfolio Generated Project" },
...
const $$splitComponentImporter = () => import("./index-DjGiUpan.js");
